defmodule Explorer.Chain.LogTest do
  ...
  describe "decode/2" do
    ...
    test "that a contract call transaction that has a verified contract returns the decoded input data" do
      ...
      topic1 = "0x" <> Base.encode16(ExKeccak.hash_256("WantsPets(string,uint256,bool)") |> elem(1), case: :lower)
      topic2 = "0x" <> Base.encode16(ExKeccak.hash_256("bob") |> elem(1), case: :lower)
